...
export class Withdrawals extends Component {
  ...
  render() {
    ...
    const withdrawals2show = withdrawals.map(withdrawal => ({
    ...
    const withdrawalsInProcess = withdrawals2show.filter(
      withdrawal => withdrawal.state === 'init'
    );
    const withdrawalsRecords = withdrawals2show.filter(
      withdrawal => withdrawal.state !== 'init'
    );
    const rowMetadata = {
