...
class Apply extends Component {
  render() {
    ...
    let balance = (user.commission || 0) - (user.totalWithdrawal || 0);
    return (
    ...
    return (
      <div>
        <ul className="content confirm">
          <li>将从您的 LeanCloud Affiliate 账户提取 <strong>人民币 {data.amount} 元</strong> 到支付宝账户<strong>（{data.alipayId}）</strong>。</li>
          <li>预计 3 - 7 个工作日到账。</li>
        </ul>
        <div className="buttons">
